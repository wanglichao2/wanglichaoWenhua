/**
 * LoginInfoServiceSoapBindingStub.java
 *
...
public class LoginInfoServiceSoapBindingStub extends org.apache.axis.client.Stub implements gov.ccm.netbar.interfaceImp.loginInfo.LoginInfo {
    ...
    public LoginInfoServiceSoapBindingStub() throws org.apache.axis.AxisFault {
         this(null);
    }

    public LoginInfoServiceSoapBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    public LoginInfoServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        if (service == null) {
    ...
    public java.lang.String login(java.lang.String username, java.lang.String password) throws java.rmi.RemoteException {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://loginInfo.interfaceImp.netbar.ccm.gov/", "login"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {username, password});
  ...
  throw axisFaultException;
    ...
    public java.lang.String logout(java.lang.String key) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://loginInfo.interfaceImp.netbar.ccm.gov/", "logout"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {key});
  ...
  throw axisFaultException;
    ...
    public java.lang.String modifyPassword(java.lang.String key, java.lang.String password, java.lang.String newPassword) throws java.rmi.RemoteException {
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://loginInfo.interfaceImp.netbar.ccm.gov/", "modifyPassword"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {key, password, newPassword});
