...
<html>
	<head>
		...
		<style type="text/css">
			body {
			    height: auto;
			    background: url("${basePath}/img/home.jpg") no-repeat center fixed;
    ...
    <div class="row white-bg dashboard-header">
        <div class="col-sm-12">
            <h2>Hello！</strong>${sessionUserName}</strong>，<s:message code="sys.title" />！</h2>
    ...
    <script src="${basePath}/js/welcome.min.js"></script>
</body>
</html>
